...
export default function SimpleBar({ width, height }: { width: number, height: number }) {
    return (<XYChart theme={lightTheme} height={height} width={width} xScale={{ type: 'band', padding: 0.1 }} yScale={{ type: 'linear' }}>
